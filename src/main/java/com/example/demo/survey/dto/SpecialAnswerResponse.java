 ...
 */
@Getter
public class SpecialAnswerResponse {
     ...
     */
    public SpecialAnswerResponse(Long answerId, Long questionId, String question, String answer, String childName, LocalDateTime createdAt) {
     ...
     */
    public static SpecialAnswerResponse fromEntity(SpecialAnswer entity) {
        return new SpecialAnswerResponse(
                entity.getId(),
                entity.getSurveySet().getSetId(),
                entity.getQuestion(),
                entity.getAnswer(),
    ...
    public SpecialAnswerResponse(SpecialAnswer answer) {
