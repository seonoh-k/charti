...
@Getter
public class GroupDateSummaryDto {
     ...
     */
    public GroupDateSummaryDto(Date recordDate, Long childId) {
    ...
    public GroupDateSummaryDto(LocalDate recordDate, Long childId) {
        this.recordDate = recordDate;
        this.childId = childId;
    }

    // 기본 생성자가 필요한 다른 로직이 있다면 유지합니다.
    public GroupDateSummaryDto() {}
}