...
@Getter
public class DailyDateSummaryDto {
     ...
     */
    public DailyDateSummaryDto(Date recordDate, Long childId) {
    ...
    public DailyDateSummaryDto(LocalDate recordDate, Long childId) {
        this.recordDate = recordDate;
        this.childId = childId;
    }

    // 기본 생성자가 필요한 다른 로직이 있다면 유지합니다.
    public DailyDateSummaryDto() {}
}