...
public class DailyAnswerResponse {
     ...
     */
    public DailyAnswerResponse(Long answerId, Long questionId, String question, String answer, String childName, LocalDateTime createdAt) {
     ...
     */
    public static DailyAnswerResponse fromEntity(DailyAnswer entity) {
    ...
    public DailyAnswerResponse(DailyAnswer answer) {
