...
public class GroupAnswerResponse {
     ...
     */
    public GroupAnswerResponse(Long answerId, Long questionId, String question, String answer, String childName, LocalDateTime createdAt) {
     ...
     */
    public static GroupAnswerResponse fromEntity(GroupAnswer entity) {
        return new GroupAnswerResponse(
                entity.getId(),
    ...
    public GroupAnswerResponse(GroupAnswer answer) {
